...
## Chart
```{raw} html
<iframe src="../../_static/andrewheekin--finm32900_hw4_fedwatch/fedwatch_latest_forecast.html" height="500px" width="100%"></iframe>

<p style="text-align: center;">Sources: </p>
```
[Full Screen Chart](../download_chart/andrewheekin--finm32900_hw4_fedwatch/fedwatch_latest_forecast.html)
...
| Seasonal Adjustment    |                                     |
| Units                  | Probability (%)                                                  |
| HTML Chart             | [HTML](../download_chart/andrewheekin--finm32900_hw4_fedwatch/fedwatch_latest_forecast.html)    |
...
|--------------------------------|--------------------------------------------------------------------------------------|
| Dataframe ID                   | [fed_funds_futures](../dataframes/andrewheekin--finm32900_hw4_fedwatch/fed_funds_futures.md)                                       |
| Sources                        |                                           |
| Providers                      |                                         |
| Provider Links                 |                                    |
...
- [andrewheekin/finm32900_hw4_fedwatch:fedwatch_latest_forecast](../../charts/andrewheekin--finm32900_hw4_fedwatch.fedwatch_latest_forecast.md)
...
|---------------------------------|--------------------------------------------------------|
| Pipeline ID                     | [andrewheekin/finm32900_hw4_fedwatch](../../index.md)              |
...
| Date of Last Code Update        | 2026-09-12 12:25:00           |
| OS Compatibility                | Windows, Linux, macOS |
| Linked Dataframes               |  [andrewheekin/finm32900_hw4_fedwatch:fed_funds_futures](../dataframes/andrewheekin--finm32900_hw4_fedwatch/fed_funds_futures.md)<br>  |
